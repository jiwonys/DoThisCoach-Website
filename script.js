...
const revealTargets = document.querySelectorAll(
  ".hero-copy, .hero-athlete-creative, .phone-stage, .feature-card, .article-preview-heading > *, .article-preview-grid article, .split-section > *, .showcase > *, .mini-screens > *, .results-strip > *, .pricing-tier, .contact-card, .safety, .support-hero, .support-grid article, .legal-page section",
);
