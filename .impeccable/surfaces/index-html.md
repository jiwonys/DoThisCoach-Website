...
Homepage redesign in Persuade mode. This work changes the marketing website only.
...
- Preserve `/app` redirects and every custom product-page `ppid`.
- Preserve current public URLs, canonical metadata, sitemap behavior, and local CTA event semantics.
- Do not fabricate screens, testimonials, metrics, medical outcomes, or install claims.
- Keep static GitHub Pages compatibility and meaningful no-JavaScript content.
...
- Physical-iPhone verification of each custom App Store gallery remains separate from browser URL verification.
