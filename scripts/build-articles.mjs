...
fs.writeFileSync(path.join(outDir, "index.html"), `<!doctype html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/><title>Workout Plans for Recreational Athletes | DoThis</title><meta name="description" content="Evidence-informed strength, conditioning, progression, and recovery guides for recreational athletes balancing sport and body-composition goals."/><link rel="canonical" href="${siteUrl}/articles/"/><meta property="og:type" content="website"/><meta property="og:title" content="DoThis Athlete Training Library"/><meta property="og:description" content="Practical plans for athletes balancing strength, sport, recovery, and body composition."/><meta property="og:url" content="${siteUrl}/articles/"/><meta property="og:image" content="${siteUrl}/assets/articles/volleyball-strength-conditioning-workout.svg"/><link rel="icon" href="../assets/dothis-logo.png"/><link rel="stylesheet" href="../styles.css"/><link rel="stylesheet" href="article.css"/><link rel="alternate" type="application/rss+xml" title="DoThis Training Library" href="../feed.xml"/><script type="application/ld+json">${JSON.stringify({ "@context": "https://schema.org", "@type": "ItemList", name: "DoThis Athlete Training Library", itemListElement: itemList })}</script></head><body class="article-page"><header class="site-header article-header"><a class="brand" href="../"><img src="../assets/dothis-logo.png" alt=""/><span>DoThis</span></a><nav aria-label="Main navigation"><a class="is-active" href="./">Training library</a><a href="../#features">App features</a><a href="../#free-preview">7 days free</a><a href="../support.html">Support</a></nav><a class="nav-cta" href="${appStoreUrl}">Try DoThis</a></header><main class="library-main"><header class="library-hero"><p class="eyebrow">DoThis Athlete Training Library</p><h1>Train for your sport without losing sight of the rest of your life.</h1><p>Complete routines, progression rules, and practical alternatives for recreational athletes. Use a guide as written, then use DoThis to generate, import, track, and review workouts around your real week.</p></header><section class="library-grid" aria-label="Training articles">${cards}</section></main><footer class="site-footer"><div class="footer-brand"><img src="../assets/dothis-logo.png" alt=""/><span>DoThis</span></div><div class="footer-links"><a href="../privacy.html">Privacy</a><a href="../terms.html">Terms</a><a href="../support.html">Support</a></div><p>Copyright <span id="year"></span> DoThis Labs LLC.</p></footer><script src="../script.js"></script><script src="article.js"></script></body></html>`);
